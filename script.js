...
//playing the game
    if (userChoice === compChoice) {
            infoText.innerHTML = '<h1 class="text-center">Its a TIE!</h1> <p class="text-center">No one has won, no one has lost. No one gets a point, this round didnt count. Try again!</p>'
    } else if (userChoice === 'rock' && compChoice === 'paper') {
        infoText.innerHTML = '<h1 class="text-center">THE ROBOTS WIN</h1> <p class="text-center">Bow down to your new overlords!</p>'
        compScore++
